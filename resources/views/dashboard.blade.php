<x-app-layout>
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        ...
                        <button id="export-btn"
                            ...
                            class="export-modal-btn text-gray-900 rounded-md px-2.5 py-1.5 text-sm font-semibold hover:bg-gray-900 hover:text-white transition">Export</button>
                    </div>
                </div>
                @empty
    ...
    <!-- Export modal -->
    <div id="export-project-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-6 w-96">
            <h2 class="text-xl font-semibold mb-4">Export Opties</h2>

            <form id="export-project-form" action="#" method="POST" class="space-y-4">
                @csrf

                <!-- Week Number -->
                <div>
                    <label class="block text-sm text-gray-700 mb-1">Week Number</label>
                    <input type="number" name="week_number" min="1" max="53" value="{{ date('W') }}"
                        placeholder="Week number" class="w-full border-none rounded-lg px-3 py-2 text-sm bg-gray-200"
                        required>
                ...
                <div>
                    ...
                    <input type="number" name="year" min="2020" max="2030" value="{{ date('Y') }}" placeholder="Year"
                        class="w-full border-none rounded-lg px-3 py-2 text-sm bg-gray-200" required>
                </div>

                <!-- Include Weekend -->
                <div class="flex items-center">
                    <input type="checkbox" id="include_weekend_checkbox" name="include_weekend" value="1"
                        class="w-4 h-4 text-gray-900 border-gray-300 rounded focus:ring-gray-900">
                    <label for="include_weekend_checkbox" class="ml-2 text-sm text-gray-700 cursor-pointer">
                ...
                <!-- Buttons -->
                <div class="flex justify-end gap-2">
                    <button type="button" id="cancel-export-project-modal" class="px-4 py-2 text-sm border rounded hover:bg-gray-100">
                        Cancel
                    </button>
                    <button type="submit" class="px-4 py-2 text-sm bg-gray-900 text-white rounded hover:bg-gray-800">
                        Export
                    </button>
                </div>
            </form>
